...
export type ImpureCounterCircuits = ImpureCircuitId<Counter.Contract<CounterPrivateState>>;

export const CounterPrivateStateId = 'counterPrivateState';

export type CounterProviders = MidnightProviders<ImpureCounterCircuits, typeof CounterPrivateStateId, CounterPrivateState>;
